<x-guest-layout>
    <div class="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
        <div class="mb-8">
            <h1 class="text-4xl font-bold text-[#82C17D]">Sign Up</h1>
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-4">
            ...
            <div class="pt-4">
                <x-primary-button class="w-full justify-center py-3 rounded-full text-lg shadow-md border-none">
                    {{ __('Sign Up') }}
                </x-primary-button>
            </div>

            <div class="mt-6 text-center text-sm text-gray-500">
                Already have an account? <a href="{{ route('login') }}" class="text-[#82C17D] font-bold underline">Log In</a>
            </div>
        </form>
    </div>

    <div class="hidden md:flex md:w-1/2 bg-[#82C17D] items-center justify-center p-12 relative">
