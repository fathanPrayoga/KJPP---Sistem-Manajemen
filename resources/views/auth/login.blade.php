        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-6">
            ...
            <div class="flex items-center justify-between mt-4 px-2">
                <label for="remember_me" class="inline-flex items-center">
                    <input id="remember_me" type="checkbox" class="rounded-full border-gray-300 text-[#82C17D] shadow-sm focus:ring-[#82C17D]" name="remember">
            ...
            <div class="mt-8">
                <x-primary-button class="w-full justify-center py-3 rounded-full transition-all duration-300 shadow-md border-none">
                    {{ __('Log In') }}
                </x-primary-button>
            </div>

            <div class="mt-6 text-center text-sm text-gray-500">
                Don't have account? <a href="{{ route('register') }}" class="text-[#82C17D] font-bold underline">Sign Up</a>
            </div>
        </form>
    </div>
</x-guest-layout>