        ...
        <div x-data="{
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-1 space-y-6">
                        ...
                        <a href="{{ route('properti.dokumen') }}" class="block">
                            <div
                                class="bg-green-50 p-8 rounded-[35px] shadow-[0_20px_40px_rgba(0,0,0,0.06)] hover:shadow-[0_20px_40px_rgba(0,0,0,0.12)] transition-shadow cursor-pointer border border-gray-50 ring-2 ring-[#82C17D] ring-offset-2">
                        ...
                        <div id="actionButtons" class="mt-6 pt-6 border-t flex gap-3 justify-end">
                            <div class="max-w-md w-full flex gap-3 justify-end">
                                <button onclick="verifySelected('approve')"
                                    class="px-4 py-3 text-white rounded-lg font-bold bg-[#82C17D] hover:bg-[#6cad67] shadow-lg transition-all">✓
                                    Verifikasi</button>
                                <button onclick="verifySelected('reject')"
                                    class="px-4 py-3 text-white rounded-lg font-bold bg-red-500 hover:bg-red-600 shadow-lg transition-all">✕
                                    Tolak</button>
                            </div>
                        </div>
                    </div>
            ...
            <div x-show="isOpen" x-cloak x-transition.opacity
                ...
                <div @click.stop
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div>
                            ...
                            <div class="space-y-2">
                                <template x-for="(doc, idx) in documents" :key="doc.id">
                                    <div
                                        class="flex items-center justify-between gap-3 p-3 bg-gray-50 rounded-lg border border-gray-200">
                                        ...
                                        <a :href="doc.url" target="_blank" rel="noopener"
                                            class="text-gray-600 hover:text-gray-800 shrink-0 flex items-center gap-2">
                        ...
                        <!-- Download All Button -->
                        <button @click="window.location.href = '/karyawan/projects/' + project.id + '/download-all'"
                        ...
                        <div class="mt-6 border-t pt-4">
                            ...
                            <div class="flex gap-3">
                                <button @click="submitVerify(project.id, 'approve')"
                                    class="flex-1 bg-[#82C17D] text-white px-4 py-2 rounded-xl hover:bg-[#6cad67] transition font-bold text-sm">
                                    Verifikasi
                                </button>

                                <button @click="submitVerify(project.id, 'reject')"
            ...
            <div id="verifyModal" class="hidden fixed inset-0 z-[60] flex items-center justify-center px-4">
                <div class="absolute inset-0 bg-black/40"
                    @click="document.getElementById('verifyModal').classList.add('hidden')"></div>
                    ...
                    <form method="POST" id="verifyForm">
                        ...
                        <div class="flex gap-3">
                            <button type="submit" name="action" value="approve"
                                class="flex-1 bg-[#82C17D] text-white px-4 py-2 rounded-lg hover:bg-[#6cad67] transition font-bold">
                                ✓ Setujui
                            </button>
                            <button type="submit" name="action" value="reject"
                                class="flex-1 bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 transition font-bold">
                                ✕ Tolak
                            </button>
                            <button type="button"
                                @click="document.getElementById('verifyModal').classList.add('hidden')"
