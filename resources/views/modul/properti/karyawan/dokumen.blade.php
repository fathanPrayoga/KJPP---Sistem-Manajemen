<x-app-layout>
    <div class="min-h-screen bg-gray-50 pb-12">
            ...
            <div id="documentModal" class="hidden fixed inset-0 z-50 flex items-center justify-center px-4">
                ...
                <div class="relative w-full max-w-lg rounded-[30px] shadow-2xl bg-white overflow-hidden z-10 max-h-[80vh] overflow-y-auto">
                    <div class="bg-[#82C17D] px-8 py-4 flex justify-between items-center sticky top-0">
                        ...
                        <button onclick="closeDocumentModal()" class="text-white text-3xl leading-none hover:text-gray-100">&times;</button>
                    </div>
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <!-- Download All Button -->
                        <button id="docModalDownloadAll" class="w-full bg-[#82C17D] text-white px-4 py-3 rounded-lg hover:bg-[#6cad67] transition font-semibold text-sm">
                            📥 Unduh Semua
                        </button>
                        ...
                        <div class="mt-6 border-t pt-4">
                            ...
                            <div class="flex gap-4">
                                <button id="docModalReject" class="flex-1 px-8 py-3 bg-white text-black rounded-full font-bold shadow-[0_4px_14px_0_rgba(0,0,0,0.1)] hover:shadow-[0_6px_20px_rgba(0,0,0,0.15)] transition-all text-sm">
                                    Tolak
                                </button>
                                <button id="docModalApprove" class="flex-1 px-8 py-3 bg-[#82C17D] text-white rounded-full font-bold shadow-[0_4px_14px_0_rgba(130,193,125,0.39)] hover:shadow-[0_6px_20px_rgba(130,193,125,0.23)] hover:bg-[#6cad67] transition-all text-sm">
                                    Verifikasi
                                </button>
                            </div>
                        </div>
    ...
    <script>
        ...
        function openDocumentModal(projectDataStr) {
            ...
            document.getElementById('docModalApprove').onclick = function() {
                submitVerify(project.id, 'approve');
            };
            
            document.getElementById('docModalReject').onclick = function() {
                submitVerify(project.id, 'reject');
            };
